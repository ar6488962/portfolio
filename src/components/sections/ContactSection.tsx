  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      toast({
        ...
        description: "Please try emailing me directly at ar6488962@gmail.com",
      });
    }
            ...
            <Card className="glass p-8">
              ...
              <div className="mt-8 pt-8 border-t border-border/50">
                ...
                <Button variant="outline" className="w-full" asChild>
                  <a href="https://calendly.com/ar6488962/30min" target="_blank" rel="noopener noreferrer">
                    Schedule a Call
                  </a>
                </Button>
              </div>
