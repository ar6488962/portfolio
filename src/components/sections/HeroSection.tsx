    ...
    >
      ...
      <div className="container relative z-10 px-4 sm:px-6 py-20 hero-content">
        <div className="max-w-4xl mx-auto text-center space-y-8">
          ...
          >
            <ScrollTypography
              text="Building data-driven solutions with clean, efficient code"
          ...
          >
            {[
              { icon: Github, href: "https://github.com/ar6488962" },
              { icon: Linkedin, href: "https://www.linkedin.com/in/aankitr123/" },
              { icon: Mail, href: "mailto:ar6488962@gmail.com" },
            ].map((social, index) => (
              <motion.a
                key={index}
                href={social.href}
